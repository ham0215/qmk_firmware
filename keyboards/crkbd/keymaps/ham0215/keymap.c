...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                          KC_LCTL,   MO(2),  KC_TAB,     KC_SPC,   MO(1), KC_LOPT
                                      //`--------------------------'  `--------------------------'
...
https://docs.qmk.fm/#/keycodes
  //,-----------------------------------------------------.                    ,-----------------------------------------------------.
            `,       1,       2,       3,       4,       5,                            6,       7,       8,       9,       0,       =,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      KC_LCMD,キャプチャ,    動画,  KC_SPC, KC_BSPC,  KC_ENT,                      KC_LEFT, KC_DOWN,   KC_UP,KC_RIGHT,       ;,       ',
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      KC_LSFT, G(KC_Z), 全角変換,カタカナ変換,半角カナ, 半角変換,                            ¥,       \,       [,       ],       |, KC_RSFT,
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
...
*/
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      KC_LCMD, G(S(KC_4)),G(S(KC_5)),KC_SPC,KC_BSPC,KC_ENT,                      KC_LEFT, KC_DOWN,   KC_UP,KC_RIGHT, KC_SCLN, KC_QUOT,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      KC_LSFT, G(KC_Z),LCTL(KC_L),LCTL(KC_K),LCTL(KC_SCLN),LCTL(KC_QUOT),   KC_BSLS,LOPT(KC_BSLS), KC_LBRC, KC_RBRC, KC_PIPE, KC_RSFT,
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
...
//,-----------------------------------------------------.                    ,-----------------------------------------------------.
  ...
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                          KC_LCTL, _______,  KC_TAB,     KC_SPC, _______, KC_LOPT
                                      //`--------------------------'  `--------------------------'
  )
};
